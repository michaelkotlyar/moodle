 ...
 */
class quizaccess_seb extends access_rule_base implements rule_overridable {
    ...
    public static function get_override_form_section_expand(edit_override_form $quizform): bool {
        $quizid = $quizform->get_quiz()->id;
        return seb_quiz_settings::record_exists_select('quizid = ?', [$quizid]);
    }
