...
Feature: Quiz group override
  ...
  @javascript
  Scenario: Hidden groups/groups teacher isn't part of should not be overridable without view/access permissions (seperate groups)
    Given the following "groups" exist:
      | name                                      | course | idnumber | visibility | participation |
      | Visible to everyone/Participation         | C1     | VP       | 0          | 1             |
      | Only visible to members/Participation     | C1     | MP       | 1          | 1             |
    ...
    And I set the field "Overrides" to "Group overrides"
    And I press "Add group override"
    And I click on "Override group" "select"
    Then I should not see "Visible to everyone/Participation" in the "Override group" "select"
    And I should not see "Visible to everyone/Non-Participation" in the "Override group" "select"
  ...
  @javascript
  Scenario: Groups teacher isn't part of can be overridable without view permissions (visible groups)
    Given the following "groups" exist:
      | name                                      | course | idnumber | visibility | participation |
      | Visible to everyone/Participation         | C1     | VP       | 0          | 1             |
      | Only visible to members/Participation     | C1     | MP       | 1          | 1             |
