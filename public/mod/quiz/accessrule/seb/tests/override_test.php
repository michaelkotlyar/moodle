...
final class override_test extends \advanced_testcase {
    ...
    public function test_override_applies_to_correct_user(): void {
        ...
        $config = helper::get_seb_config_content($this->quiz->cmid, $overrideuser->id);
        ...
        $config = helper::get_seb_config_content($this->quiz->cmid, $user->id);
        $config = $config;
    }
    ...
    public function test_override_settings_values(): void {
        ...
        $sebconfig = seb_quiz_settings::get_by_quiz_id($this->quiz->id, $overrideuser->id);
        ...
        $sebconfig = seb_quiz_settings::get_by_quiz_id($this->quiz->id, $user->id);
    ...
    public function test_override_cache(): void {
        ...
        $quizsettings = seb_quiz_settings::get_by_quiz_id($this->quiz->id, $overrideuser->id);
