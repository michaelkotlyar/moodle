...
$string['privacy:metadata:quizaccess_seb_quizsettings:overrideid'] = 'ID of the override the settings are attached to.';
...
$string['seb:manage_filemanager_sebconfigfile_override'] = 'Override SEB quiz setting: Select SEB config file';
...
$string['seb:manage_seb_configuremanually_override'] = 'Override manual configuration';
...
$string['seb:manage_seb_templateid_override'] = 'Override template configuration';
...
$string['seb:manage_seb_usesebclientconfig_override'] = 'Override SEB client configuration';
