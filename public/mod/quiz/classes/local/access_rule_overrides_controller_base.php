...
abstract class access_rule_overrides_controller_base {
    ...
    /**
     * Fetch an array of setting names and values for the access rule override.
     *
     * Should use the user id provided when instantiated to fetch the override settings for the specific user. If the user id is
     * null, should attempt to fetch default override settings.
     *
     * E.g. ['pluginrule_enabled' => 1, 'pluginrule_timerlength' => 5, 'pluginrule_buzzersoundeffect' => 'Buzz']
     *
     * @see mod_quiz\access_manager::get_override_settings() Called to get the override settings for a user in the quiz.
     * @param ?int $userid The user id to fetch the override settings for, or null to fetch quiz default override settings.
     * @return ?array
     */
     ...
     * overrides.php page to render quiz access plugin override properties in the override HTML table.
     *
     * For example, if the respective access rule override was enabled, we would add to the $fields array the name of the access
     * rule and the properties of the access rule override will be added to the $values array.
     *
     * E.g. [[...$fields, 'Timer access rule'], [...$values, "Timer: 5 mins\nSound effect: Buzz"]]
     *
     * @link ../../overrides.php
     ...
     * @param array $fields The access rule fields to display, e.g, [...$fields, "Timer access rule"]
     * @param array $values The value of the field at the same index, e.g, [...$values, "Timer: 5 mins\nSound effect: Buzz]
     * @return array [$fields, $values] An array of the effective override fields and values.
     */
